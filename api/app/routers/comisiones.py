...
def list_originadores(case_id: int, current_user: CurrentUser, repo: RepoDep) -> list[OriginadorOut]:
...
def set_originadores(case_id: int, body: OriginadoresSetIn, current_user: CurrentUser, repo: RepoDep, _: dict = require_permission("expedientes", "editar")) -> list[OriginadorOut]:
    try:
...
def resumen_comisiones(current_user: CurrentUser, repo: RepoDep, mes: str) -> list[ResumenComisionOut]:
...
def reconocer_comision(income_id: int, current_user: CurrentUser, repo: RepoDep, _: dict = require_permission("expedientes", "editar")) -> list[ComisionOut]:
    try:
...
def revertir_comision(commission_id: int, current_user: CurrentUser, repo: RepoDep, _: dict = require_permission("expedientes", "editar")) -> ComisionOut:
    try:
